...
class lux_vimeo
{
	function shortcode($atts, $content = null)
	{
		...
		return
			"<iframe src='//player.vimeo.com/video/$clip_id?title=$title&amp;byline=$byline&amp;portrait=$portrait&amp;color=$color' width='$width' height='$height' frameborder='0'></iframe>";
	}
}

add_shortcode('lux_vimeo', array('lux_vimeo', 'shortcode'));
