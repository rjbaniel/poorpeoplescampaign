...
function ppc_enqueue_stylesheet() {
	wp_enqueue_style( 'ppc', get_stylesheet_directory_uri() . '/style.css', array(), 1.0, 'all' );
}
add_action( 'wp_enqueue_scripts', 'ppc_enqueue_stylesheet' );
