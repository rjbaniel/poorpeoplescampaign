					...
					<div id="minor-publishing">
						...
						<div id="minor-publishing-actions">
							...
							<div id="preview-action">
								...
								?>
								<input type="submit" value="<?php esc_attr_e( 'Preview', 'simple-pay' ); ?>" id="simpay-preview-button" class="simpay-button button" data-action="<?php echo esc_url( $preview_link ); ?>" />
							</div>
							<div class="clear"></div>
